# Deploying Rock Steady Boxing Woodland Hills
...
2. Enter `rocksteadyboxingwoodlandhills.com` → **Verify** → **Add domain**.
...
- Set `https://rocksteadyboxingwoodlandhills.com` as the primary domain so
